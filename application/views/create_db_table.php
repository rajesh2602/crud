        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="user_add">
                        <div class="">
                            <span class="title">Create Database and Table</span>
                        </div>
                                    ...
                                    <div class="form-body" id="mainDIV">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="product_name">Database Name</label>
                                                <input type="text" class="form-control" id="prod_name" name="database_name" placeholder="Enter Database Name">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label for="product_name">Table Name</label>
                                                <input type="text" class="form-control" id="prod_name" name="table_name[]" placeholder="Table Name">
                                            </div>
                                        </div>
                                        <div class="row">
